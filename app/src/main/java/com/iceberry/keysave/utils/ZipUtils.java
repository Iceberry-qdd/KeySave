package com.iceberry.keysave.utils;
...
/**
 * @author YuShuangPing
 * @Description: 链接：https://blog.csdn.net/yushuangping/article/details/84038477
 */
public class ZipUtils {
     ...
     * @throws Exception
     */
    public static boolean ZipFolder(String srcFileString, String zipFileString) throws Exception {


        //压缩
        //LogUtils.LOGE("---->"+file.getParent()+"==="+file.getAbsolutePath());
        if (!fileIsExists(zipFileString)){
            //创建文件
