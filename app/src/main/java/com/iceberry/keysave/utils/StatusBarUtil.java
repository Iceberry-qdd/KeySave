...
/**
 * @author 小龙surpass
 * @Description: 状态栏设置，链接：https://blog.csdn.net/Fly_li_sir/article/details/83787582
 */
...
//            }
    ...
    private static boolean isMIUI6Later() {
        try {
            @SuppressLint("PrivateApi") Class<?> cla = Class.forName("android.os.SystemProperties");
